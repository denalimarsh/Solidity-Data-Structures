const StackMapping = artifacts.require('StackMapping');
...
contract('StackMapping', function (accounts) {

  describe('StackMapping contract deployment', function() {

    beforeEach(async function() {
      this.stack = await StackMapping.new();
    });
